...
export function MagneticText({ 
  ...
  return (
    ...
    >
      ...
      <span className={cn(fontSize, "font-bold tracking-tighter tracking-wide", textColor || "text-white")}>{text}</span>
      ...
      >
        ...
        >
          <span className={cn(fontSize, "font-bold tracking-tighter whitespace-nowrap tracking-wide", cursorTextColor || "text-black")}>
            {hoverText}
          </span>
        </div>
      </div>
